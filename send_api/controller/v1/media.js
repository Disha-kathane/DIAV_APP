...
//             console.log('i am in getusers==================>' + apikeys);
//             userService.getOptoutUserId(apikeys, (err, result) => {
//                 console.log('getOptoutUserId result==============================>' + JSON.stringify(result));

//                 if (err) {
//                     console.log('getOptoutUserId error==============================>' + JSON.stringify(err));
//                     callback(err);
//                 }
...
//             console.log('i am in getusersetting');
//             userService.getMediaUserSettings(userid, wanumber, (err, result) => {
//                 console.log('getMediaUserSettings==============================>' + JSON.stringify(result));
//                 if (err) {
//                     console.log('getMediaUserSettings==============================>' + JSON.stringify(err));
//                     return callback(err.message);
//                 }
//                 if (result != undefined && result != null && result.length > 0) {
//                     let authtoken = result[0].authtoken;
//                     let waurl = result[0].waurl;
//                     callback(null, authtoken, waurl, data, userid);
//                 }

//             });
//         }

//         let getmedia = function (authtoken, waurl, data, userid, callback) {
...
//                 console.log('uploadWhatsappMedia response==============================>' + JSON.stringify(response));
//                 let result = response.media[0].id;
//                 sendService.insertMedia(result, mediatype, FilePath, tmpFileName, userid, (err, insertMediaResult) => {
//                     callback(err, result);
//                 });
//                 callback(null, result);
//             }).catch((error) => {
//                 if (error) {
//                     console.log('uploadWhatsappMedia error==============================>' + JSON.stringify(err));
...
//     } catch (error) {
//         console.log('Media API Error=====================>' + JSON.stringify(error));
