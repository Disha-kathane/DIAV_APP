...
const callbackService = require('../../services/v1/wacallback_prod_11022022');
const sendService = require('../../services/v1/send_prod_11022022');
    ...
    try {
                    ...
                    if (obj.contacts != undefined && obj.messages != undefined) {
                        ...
                        if (obj.messages[0].type == 'text' && obj.messages[0].text != undefined) {
                            ...
                            async.waterfall([
                                ...
                                function (r, cb) {
                                    sendService.fetchLastTextMessage(contactno, (err, result) => {
                                        if (err) {
                            ...
                            async.waterfall([
                                function (callback) {
                                    if (obj.messages[0].type == 'interactive' && obj.messages[0].interactive != undefined) {
                                        sendService.fetchPreviousButtonClick(obj.contacts[0].wa_id, obj.messages[0].context.id, bodyText, (err, result) => {
                                            console.log('fetchPreviousButtonClick(' + contactno + ')================================>' + JSON.stringify(result));
                                ...
                                function (fetchPreviousButtonResult, callback) {
                                    if (fetchPreviousButtonResult.length > 0 && fetchPreviousButtonResult[0].session > 0) {
                                        console.log('fetchPreviousButtonResult(' + contactno + ')================================>' + JSON.stringify(fetchPreviousButtonResult));
                                ...
                                function (fetchPreviousButtonResult, callback) {
                                    sendService.fetchFlowSession(contactno, userId, (err, sessionResult) => {
                                        if (sessionResult != undefined) {
                                            console.log('fetchFlowSession(' + contactno + ')==========================>' + JSON.stringify(sessionResult));
                                ...
                                function (userId, sessionResult, callback) {
                                    if (sessionResult.session == 0) {
                                        sendService.fetchFlowId(userId, bodyText, (err, flowResult) => {
                                            console.log('sessionResult session 0 (' + contactno + ')==========================>' + JSON.stringify(sessionResult));
                                            if (err) {
                                                return callback({ code: 404, status: 'FAILED', message: 'No Flow Found' });
                                            }
                                            else {
                                                console.log('fetchFlowId (' + contactno + ')==========================>' + JSON.stringify(flowResult));
                                        ...
                                        console.log('sessionResult session 1 (' + contactno + ')==========================>' + JSON.stringify(sessionResult));
                                ...
                                function (userId, flowid, sessionResult, callback) {
                                    if (sessionResult.next_message_id == null) {
                                        sendService.fetchInitialMessage(flowid, (err, result) => {
                                            console.log('fetchInitialMessage (' + contactno + ')=====================>' + JSON.stringify(result));
                                        ...
                                        if (sessionResult.is_node_option == 1) {
                                                ...
                                                if (sessionResult.validator == 'isNumeric') {
                                                    if (validator.isNumeric(bodyText)) {
                                                        sendService.fetchNextNodeOption(flowid, bodyText, contactno, (err, result) => {
                                                            console.log('fetchNextNodeOption (' + contactno + ')=====================>' + JSON.stringify(result));
                                                ...
                                                sendService.fetchNextNodeOption(flowid, bodyText, contactno, (err, result) => {
                                                    ...
                                                    if (result!= undefined) {
                                                        ...
                                                        if(sessionResult!=null){
                                                            if(sessionResult.error_message.length > 0){
                                                                return callback({ code: 400, status: 'FAILED', message: sessionResult.error_message });
                                                            }
                                                            else{
                                            ...
                                            if (sessionResult.is_validator == 1) {
                                                if (sessionResult.validator == 'isNumeric') {
                                                    if (validator.isNumeric(bodyText)) {
                                                        sendService.fetchNextMessage(flowid, sessionResult.next_message_id, (err, result) => {
                                                            console.log('fetchNextMessage  (' + contactno + ')=====================>' + JSON.stringify(result));
                                                            if (result[0] != undefined) {
                                                                let flowTmpPayload = JSON.parse(result[0].node_body);
                                                                let flowType = result[0].typenode;
                                                                callback(err, userId, flowid, flowType, flowTmpPayload, result[0].next_message_id, result[0].id, sessionResult, result[0].placeholder, result[0]);
                                                ...
                                                sendService.fetchNextMessage(flowid, sessionResult.next_message_id, (err, result) => {
                                                    console.log('fetchNextMessage(No Validation block) (' + contactno + ')=====================>' + JSON.stringify(result));
                                                    if (result[0] != undefined) {
                                ...
                                function (flowType, flowTmpPayload, next_message_id, current_message_id, sessionResult, placeholder, nextMessageResult, callback) {
                                    ...
                                    if (flowType == "List") {
                                        ...
                                        console.log('botMessagePayload (' + contactno + ')==========>' + JSON.stringify(botMessagePayload));
                                        ...
                                        console.log('Button (' + contactno + ')===================>' + JSON.stringify(flowTmpPayload));
                                        ...
                                        if (flowTmpPayload.buttons.length > 0) {
                                            ...
                                            if (flowTmpPayload.body_text != null) {
                                                console.log('flowTmpPayload.body_text (' + contactno + ')===================>' + JSON.stringify(flowTmpPayload.body_text));
                                        ...
                                        console.log('Condition (' + contactno + ')==========>' + JSON.stringify(flowTmpPayload));
                                        callback(null, flowTmpPayload, flowTmpPayload, sessionResult, next_message_id, current_message_id, 700, flowType, placeholder, nextMessageResult);
                                    }
                                    else if (flowType == "Webhook") {
                                        console.log('Webhook (' + contactno + ')==========>' + JSON.stringify(flowTmpPayload));
                                ...
                                function (flowTmpPayload, botMessagePayload, sessionResult, next_message_id, current_message_id, flowType, typeNode, placeholder, nextMessageResult, callback) {
                                    ...
                                    console.log('Payload result (' + contactno + ')==========>' + JSON.stringify(result));
                                    callback(null, result);
                                }
                            ], (err, result) => {
                                console.log('Error (' + contactno + ')===============================>' + JSON.stringify(err));
                ...
                async.waterfall([
                    ...
                    function (filedata, done) {
                        if (msgType == 0 || msgType == 1 || msgType == 2 || msgType == 3 || msgType == 7 || msgType == 10) {
                            ...
                            // data.append('uploadfile', fs.createReadStream(tmpFile));

                            // let config = {
                            //     method: 'POST',
                            //     url: 'https://console.pinbot.ai/api/upload-media',
                            //     headers: {
                            //         ...data.getHeaders()
                            //     },
                            //     data: data
                            ...
                            //         console.log('Upload Media ===============================>' + JSON.stringify(response.data));
                            //         publicMediaUrl = response.data.data;
                            //         messageText = {
                            //             "body": "<a href='" + response.data.data + "'>Media</a>"
                            //         }
                            //         done(null, messageText);
                            //     })
                    ...
                    function (c, done) {
                        ...
                        //     async.waterfall([
                        //         function (cb) {
                        //             sendService.isFlowChatKeyword(obj.messages[0].text.body, (err, result) => {
                        //                 if (err) {
                        //                     console.log('isFlowChatKeyword error=====================>' + JSON.stringify(err));
                        //                     cb(err);
                        //                 }
                        //                 else {
                        //                     console.log('isFlowChatKeyword result=====================>' + JSON.stringify(result));
                        //                     if (result[0].c > 0) {
                        //                         cb('Text is predefined keyword');
                        //                     }
                        //                     else {
                        ...
                        //         },
                        //         function (r, cb) {
                        //             sendService.fetchLastTextMessage(waRecipientNo, (err, result) => {
                        //                 if (err) {
                        //                     cb(err);
                        //                 }
                        //                 else {
                            ...
                            for (let y = 0; y < attrKeyArr.length; y++) {
                                ...
                                sendService.fetchPlaceholderValue(to, tmpAttrKey, (err, result) => {
                                    ...
                                    if (result.length > 0) {
                                        ...
                                        if (tmpAttrKey == 'name') {
                                            tmpObj = tmpObj.replace('\{\{' + tmpAttrKey + '\}\}', obj.contacts[0].profile.name);
                                            console.log('fetchPlaceholderValue==========================>' + JSON.stringify(tmpObj));
                                        }
                                        else if (tmpAttrKey == 'wanumber') {
                                            tmpObj = tmpObj.replace('\{\{' + tmpAttrKey + '\}\}', obj.contacts[0].wa_id);
                                            console.log('fetchPlaceholderValue==========================>' + JSON.stringify(tmpObj));
                                        }
                                    }
                                    ...
                                    if (y == (attrKeyArr.length - 1)) {
                                        ...
                                        bodyContent = messagePayload.interactive;
                                        sendMessageCallback(null, messagePayload);
                                    }
                                });
                            }
        ...
        let saveChatAttributes = (obj, payload, _resultMessageId, next) => {
            ...
            switch (typeNode) {
                case "List":
                    ...
                    break;
                case "Question":
                    messageContent = payload.payload;
                    break;
                case "Button":
                    messageContent = payload.payload.body.text;
                    break;
        ...
        let callLiveChatWebHook = (obj) => {
            ...
            async.waterfall([
                ...
                if (err) {
                    console.log('callLiveChatWebHook error==================================>' + err);
                }
                else {
                    console.log('callLiveChatWebHook result==================================>' + result);
                }
            });
        }
                        ...
                        for (let y = 0; y < attrKeyArr.length; y++) {
                            ...
                            sendService.fetchPlaceholderValue(obj.contacts[0].wa_id, tmpAttrKey, (err, fetchPlaceholderValueResult) => {
                                ...
                                if (fetchPlaceholderValueResult.length > 0) {
                                    ...
                                    if (tmpAttrKey == 'name') {
                                        tmpEmailObj = tmpEmailObj.replace('\{\{' + tmpAttrKey + '\}\}', obj.contacts[0].profile.name);
                                        console.log('fetchPlaceholderValue==========================>' + JSON.stringify(tmpEmailObj));
                                    }
                                    else if (tmpAttrKey == 'wanumber') {
                                        tmpEmailObj = tmpEmailObj.replace('\{\{' + tmpAttrKey + '\}\}', obj.contacts[0].wa_id);
                                        console.log('fetchPlaceholderValue==========================>' + JSON.stringify(tmpEmailObj));
                                    }
                                }
