...
const callbackService = require('../../services/v1/wacallback_ready_21022022');
const sendService = require('../../services/v1/send_ready_21022022');
            ...
            async.waterfall([
                function (webHookCb) {
                    ...
                    if (webHookAttrKeyArr != null && webHookAttrKeyArr.length > 0) {
                        console.log('webHookAttrKeyArr_1=============================>' + webHookAttrKeyArr.length);
                        ...
                        //         console.log('webHookAttrKeyArr_2=============================>' + y);
                        ...
                        // async.each(webHookAttrKeyArr, (mid, callback) => {
                        //     async.waterfall([
                        //         (d1) => {
                        //             let tmpWebhookKey = mid.replace(/{{/g, '').replace(/}}/g, '');
                        //             console.log('tmpWebhookKey=============================>' + mid);
                        //             sendService.fetchPlaceholderValue(contactno, tmpWebhookKey, (err, result) => {
                        //                 if (result.length > 0) {
                        //                     let tmpWebValue = result[0].attrvalue;
                        //                     console.log('tmpWebValue=============================>' + tmpWebValue);
                        ...
                        //                 }
                        //                 else {
                        //                     if (tmpWebhookKey == 'name') {
                        //                         tmpWebObj = tmpWebObj.replace('\{\{' + tmpWebhookKey + '\}\}', userProfileName);
                        //                     } else if (tmpWebhookKey == 'wanumber') {
                        //                         tmpWebObj = tmpWebObj.replace('\{\{' + tmpWebhookKey + '\}\}', userMobileNumber);
                        //                     }
                        //                     d1(null, 1);
                        //                 }
                        //             });
                ...
                function (webHookApi, webHookCb) {
                    ...
                    console.log('WEBHOOK_API==========================>' + webHookApi);
                    var config = {
                        method: 'post',
                        url: webHookApi,
                        headers: {
