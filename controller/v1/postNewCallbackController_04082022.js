...
module.exports = (req, res) => {
    ...
    let processMessage = (result, obj, done) => {
        ...
        if (customCallback != undefined && customCallback.length > 0) {
            ...
            callCustomCallback(customCallback, body);
        }
        ...
        async.waterfall([
            ...
            (r, createPayloadCallback) => {
                if (flowType == "Question") {
                    ...
                    if (mType == -1) {
                        Object.keys(flowTmpPayload).forEach(function (key) {
                            let value = flowTmpPayload[key];
                            if (value != undefined) {
                                console.log('Keys===========================>' + value.type + ', ' + contactno + ', ' + JSON.stringify(flowTmpPayload));
