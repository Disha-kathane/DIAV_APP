                                    ...
                                    async.waterfall([
                                        ...
                                        if (err != null && err.code == 404) {
                                            callbackService.getReplyMessage(bodyText, wanumber, (err, result) => {
                                                ...
                                                let autoResponseTemplateName = result[0].hsmname != null ? result[0].hsmname : '';
                                                let autoResponseFlag = result[0].auto_response_flag != null ? result[0].auto_response_flag : '';
                                                ...
                                                if (bodyText.toLowerCase() == unSubscribeKeyword.toString().toLowerCase() && unSubscribeMessage.length > 0) {
                                                    ...
                                                    if (autoResponseFlag == 1) {
                                                        sendTemplateMessage(autoResponseTemplateName, userId, contactno, wabaNumber, (err, result) => {
                                                    ...
                                                    async.waterfall([
                                                        ...
                                                        function (result, chatAttrInsertId, executeWebhookResult, fetchNextNodeOptionWebhookResult, webhookCallback) {
                                                            ...
                                                            if (fetchNextNodeOptionWebhookResult.typenode == "Webhook") {
                                                                ...
                                                                async.waterfall([
                                                                    function (webhookCallback_1) {
                                                                        sendService.updateNextMessageIdInSession(fetchNextNodeOptionWebhookResult.id, fetchNextNodeOptionWebhookResult.next_message_id, fetchNextNodeOptionWebhookResult.current_message_id, 0, fetchNextNodeOptionWebhookResult.typenode, fetchNextNodeOptionWebhookResult.placeholder, (err, result1) => {
                                                                            webhookCallback_1(err, result1);
                                                                        });
                                                                    },
                                                                    function (result1, webhookCallback_1) {
                                                                        let webhookPayload = {
                                                                            flow_id: fetchNextNodeOptionWebhookResult.id,
                                                                            next_message_id: fetchNextNodeOptionWebhookResult.next_message_id,
                                                                        ...
                                                                        saveChatAttributes(obj, webhookPayload, null, (err, chatAttrInsertId) => {
                                                                            ...
                                                                            webhookCallback_1(err, webhookPayload, chatAttrInsertId);
                                                                        });
                                                                    },
                                                                    function (result, chatAttrInsertId, webhookCallback_1) {
                                                                        executeWebhook(obj.contacts[0].wa_id, result, (err, executeWebhookResult) => {
                                                                            console.log('executeWebhook=====================>' + JSON.stringify(executeWebhookResult));
                                                                            webhookCallback_1(err, result, chatAttrInsertId, executeWebhookResult);
                                                                        });
                                                                    },
                                                                    function (result, chatAttrInsertId, executeWebhookResult, webhookCallback_1) {
                                                                        sendService.updateWebhookAttrValueById(chatAttrInsertId, executeWebhookResult.data, (err, updateAttrValueResult) => {
                                                                            if (err) {
                                                                                console.log('updateWebhookAttrValueById err=========================>' + JSON.stringify(err));
                                                                            }
                                                                        ...
                                                                        if (tmpWebhookResCodeArr.length > 0) {
                                                                            ...
                                                                            if (tmpWebhookResCodeArr.includes(tmpWebhookResCode)) {
                                                                                sendService.fetchNextNodeOptionWebhook(tmpWebhookResCode, contactno, (err, fetchNextNodeOptionWebhookResult) => {
                                                                                    ...
                                                                                    webhookCallback_1(err, result, chatAttrInsertId, executeWebhookResult, fetchNextNodeOptionWebhookResult[0]);
                                                                                });
                                                                            }
                                                                        }
                                                                    },
                                                                    function (result, chatAttrInsertId, executeWebhookResult, fetchNextNodeOptionWebhookResult, webhookCallback_1) {
                                                                        console.log('fetchNextNodeOptionWebhookResult===========================>' + fetchNextNodeOptionWebhookResult.node_body.toString());
                                                                        let tmpNodeBody = JSON.parse(fetchNextNodeOptionWebhookResult.node_body);
                                                                        if (fetchNextNodeOptionWebhookResult.typenode == "Message") {
                                                                    ...
                                                                    webhookCallback(result[0], webhookCallback);
                                                                });
                ...
                async.waterfall([
                    ...
                    function (result, done) {
                        ...
                        botUtils.callWhatsAppApiPUT(wabaUrl, api, statusPayload, httpMethod, requestType, apiHeaders).then((response) => {
                            console.log('MARK_MESSAGE_AS_READ RESPONSE : (' + waRecipientNo + ')' + JSON.stringify(response));
                            done(null, response);
                        }).catch((err) => {
                            console.log('MARK_MESSAGE_AS_READ ERROR : (' + waRecipientNo + ')' + err);
                            done(err);
                        });
                    },
                    function (res_, done) {
            ...
            async.waterfall([
                (templateMessageCallback) => {
                    sendService.fetchTemplate(autoResponseTemplateName, userId, wabaNumber, (err, templateMessageResult) => {
                        console.log('fetchTemplate========================>' + JSON.stringify(templateMessageResult));
                        templateMessageCallback(err, templateMessageResult);
                    });
                },
            ...
            async.waterfall([
                ...
                function (fetchEmailDataResult, sendEmailCallback) {
                    ...
                    if (attrKeyArr != null && attrKeyArr.length > 0) {
                        ...
                        replacePlaceholder(tmpEmailObj, attrKeyArr, obj.contacts[0].wa_id, userProfileName, userMobileNumber, (err, result) => {
