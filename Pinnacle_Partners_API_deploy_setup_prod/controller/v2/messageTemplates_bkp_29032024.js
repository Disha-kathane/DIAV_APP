        ...
        let createpayload = function (access_token, wabaid, userid, callback) {
            if (ComponentsData.length > 0) {
                if (ComponentsData.findIndex(x => x.type.toLowerCase() === "body") > -1) {
                    ...
                    // console.log(ComponentsData[bodyindex]);
                    // body_type = ComponentsData[bodyindex].type;
                ...
                if (ComponentsData.findIndex(x => x.type.toLowerCase() === "carousel") > -1) {
                    ...
                    for (let i = 0; i < ComponentsData[carouselindex].cards.length; i++) {
                        if (ComponentsData[carouselindex].cards[i].components!=undefined && ComponentsData[carouselindex].cards[i].components.findIndex(x => x.type.toLowerCase() === "body") > -1
                        ) {
                        ...
                        if (ComponentsData[carouselindex].cards[i].components!=undefined && ComponentsData[carouselindex].cards[i].components.findIndex(x => x.type.toLowerCase() === "buttons") > -1) {
                        ...
                        if (ComponentsData[carouselindex].cards[i].components!=undefined && ComponentsData[carouselindex].cards[i].components.findIndex(x => x.type.toLowerCase() === "header") > -1) {
                ...
                if (hasImage) {
                    ...
                    userService.get_URL_headerhandel(header_handlerquery, (err, result) => {
                        if (err) {
                            ...
                            // if (head_media_url111.mime_type === "image/jpeg" || head_media_url111.mime_type === "image/jpg" || head_media_url111.mime_type === "image/png") {
                            // console.log("inside image simple temp check");
                            if (head_media_url221.length > 0) {
                                if (head_media_url111.mime_type === "image/jpeg" || head_media_url111.mime_type === "image/jpg" || head_media_url111.mime_type === "image/png") {
                    ...
                    userService.get_URL_headerhandel(header_handlerquery, (err, result) => {
                        if (err) {
                            ...
                            head_media_url111 = result[0];
                            head_media_url221 = result;
                            console.log("head_media_url111",head_media_url221.length);
                            if (head_media_url221.length > 0) {
                                if (head_media_url111.mime_type === "video/mp4") {
