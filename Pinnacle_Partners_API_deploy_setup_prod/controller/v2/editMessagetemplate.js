...
module.exports = (req, res) => {
    try {
        ...
        console.log('EDIT MESSAGE_TEMPLATE : ' + JSON.stringify(req.body));
        let objData = null;
        let components = [];
        ...
        let createpayload = function (access_token, wabaid, userid, callback) {
            userService.gettemplatedetails(name, language, category, (err, result) => {
                if (err) {
                    return callback(err)
                }
                ...
                if (result != null && result.length > 0) {
                    console.log("result[0].waba_approval_response_id----------------------------->", result.length, typeof (result[0].waba_approval_response_id))
                    waba_approval_response_id = result[0].waba_approval_response_id
                    resubmit_counter = result[0].resubmit_counter;
                                                                ...
                                                                if (head_media_url221.length > 0) {
                                                                    if (head_media_url111.mime_type === "image/jpeg" || head_media_url111.mime_type === "image/jpg" || head_media_url111.mime_type === "image/png") {
                                                                        ...
                                                                        if (i == ComponentsData[carouselindex].cards.length - 1) {
                                                                            callback(null, objData, imagedata, waba_approval_response_id);
                                                                        }
                                                                    } else {
                                                                        res.send({
                                                                            code: "WA100",
                                                            ...
                                                            if (err) {
                                                                ...
                                                                if (head_media_url221.length > 0) {
                                                                    ...
                                                                    if (head_media_url111.mime_type === "video/mp4") {
                                                                        ...
                                                                        if (i == ComponentsData[carouselindex].cards.length - 1) {
                                                                            callback(null, objData, videodata, waba_approval_response_id);
                                                                        }
                                                                    }
                                                                    else {
                                                                        // console.log("outside image simple temp check");
                                ...
                                for (let i = 0; i < urldata.length; i++) {
                                    ...
                                    if (urldata[i].type.toLowerCase() === "url") {
                                        ...
                                        if (urldata[i].example != null ? urldata[i].example : null) {
                                            console.log("inside if dynamic url dubble --------------------->");
                            ...
                            if (ComponentsData.findIndex(x => x.type.toLowerCase() === "header") > -1) {
                                ...
                                if ((ComponentsData1 != undefined && ComponentsData1 != "")) {
                                    ...
                                    if (hasImage) {
                                                    ...
                                                    userService.get_URL_headerhandel(header_handlerquery, (err, result) => {
                                                        if (err) {
                                                            ...
                                                            if (head_media_url221.length > 0) {
                                                                ...
                                                                callback(null, objData, documentdata, waba_approval_response_id);
                                                                // }
                                                            } else {
                                                                res.send({
                                                                    code: "WA100",
                                        ...
                                        callback(null, objData, locationdata, waba_approval_response_id);
                                    }
                                    else if (hasText) {
                                        ...
                                        callback(null, objData, textdata, waba_approval_response_id);
                                    }
                                } else {
                                    res.send({
                                        code: "WA100",
        ...
        let createtemplate = function (objData, data, waba_approval_response_id, callback) {
            wabaid = data.wabaid;
            // console.log({data})
            whatsappService.messageTemplate11(objData, wabaid, waba_approval_response_id, (err, result) => {
                if (err) {
                    console.log({ err });
                    let tempError = null;
                    // console.log("err.response.data.error ------------------------------------------->", err)
                    if (err.response.data.error.error_user_msg != undefined && err.response.data.error.error_user_msg != "") {
                    ...
                    userService.updateTemplateDetails(waba_approval_response_id, resubmit_counter, data, carousel_payload, flowid1, (err, insertTemplateresult) => {
                        if (err) {
                            console.log(err);
                        } else {
                            // console.log(result);
