...
module.exports = (req, res) => {
    ...
    async.waterfall([
        ...
        (fetchapikeywanumberResult, done) => {
            ...
            switch (msgtype) {
                case "text":
                    ...
                    done(null, fetchapikeywanumberResult, bodycontent, category, categoryId, null);
                    break;
                case "document":
                    bodycontent = {
                ...
                case 'template':
                    ...
                    sendService.templatetitleuserid(temptitle, userid, (err, templatetitleuseridResult) => {
                        if (err) {
                            ...
                            category = templatetitleuseridResult[0] != undefined ? templatetitleuseridResult[0].category : '';
                            templateid = templatetitleuseridResult[0] != undefined ? templatetitleuseridResult[0].tempid : '';
        ...
        (response, category, categoryId, done) => {
            ...
            console.log('userid==========================>' + userid);
            sendService.insertMessageInSentMasterAPI00(id, userid, recipientnumber, req.body, messageid, msgType, campaignid, wanumber, wa_msg_setting_id, direction, errorCode, errorDesc, clientPayload, bodycontent, fbtrace_id, category, categoryId, templateid, (err, insertMessageInSentMasterAPIResult) => {
                if (err) {
