...
module.exports = async (req, res) => {
    try {
        ...
        if (tempListResponse.head_temptype == 1 && tempListResponse.head_mediatype != 5 && tempListResponse.head_temptype != null) { // media
            ...
            //     wafile = await axios.get(`https://wpstaging.pinnacle.in/assets/watemplates/${userId}/${tempListResponse.head_media_filename}`, {
            //         responseType: 'arraybuffer'
            //     });
            //     fileType = mimeTypes.lookup(`https://wpstaging.pinnacle.in/assets/watemplates/${userId}/${tempListResponse.head_media_filename}`);
            ...
            if (tempListResponse.head_mediatype === '6') {
                ...
                console.log("corousalArray------------------->", corousalArray)
            ...
            console.log("=================>cuploadresponse", cuploadresponse);
        ...
        if (tempListResponse.button_option_string.length > 0) {
            ...
            for (let p = 0; p < tempListResponse.button_option_string.length; ++p) {
                ...
                if (tempListResponse.button_option_string[p].copy_offer_code != null &&
                    ...
                    let tmpButtonBody = {
                        "type": "copy_code",
                        // "text": tempListResponse.button_option_string[p].copy_offer_code.offer_button_text,
            ...
            console.log(JSON.stringify(buttonOptionBody));
            // }
        ...
        if (mediaType == "CAROUSEL") {
            ...
            //console.log("---------------->", corousalArray.length);
            for (let i = 0; i < corousalArray.length; i++) {
                ...
                if (qrTestValue == null && button_text != null) {
                    ...
                    console.log("only url button");

                } else if (qrTestValue != null && button_text == null) {
                    console.log("only quickreply button");
                    if (bodySampleContent != "") {
                        objdata = {
                            "components": [
                                {
                    ...
                    console.log("both url and buttons is present");
                    if (bodySampleContent != "") {
                        objdata = {
                            "components": [
                                {
        ...
        console.log('IN CATCH MessageTemplate new =============>' + error);
        console.log(error);
        ...
        else if (error.response.data.error != undefined && error.response.data.error.message != undefined) {
...
//         const apiKey = req.headers.apikey;
//         const { userId, wabaId } = await userService.getUserId(apiKey);
//         console.log({ userId, wabaId, apiKey });
...
//                 wafile = await axios.get(`http://13.200.170.27/assets/watemplates/${userId}/${tempListResponse.head_media_filename}`, {
//                     responseType: 'arraybuffer'
//                 });
//                 fileType = mimeTypes.lookup(`http://13.200.170.27/assets/watemplates/${userId}/${tempListResponse.head_media_filename}`);
//                 fileBuffer = wafile.data;
//                 fileLength = wafile.headers['content-length'];
//                 fileType = wafile.headers['content-type'];
//             }
